...
?>
	...
	<div class="d1">
		<h4> <form action="change_add_doc.php" method="post" enctype="multipart/form-data">
	...
	<div class="d1 d2">
		...
		<form action="change_add_doc.php" method="post" enctype="multipart/form-data">
						...
						<marquee direction="left" onMouseOver="this.stop()" onMouseOut="this.start()"><input type="text" name="data"  style="width: 100%;border:none;font-size: 30px;"  value="<?php echo $Admission['notice'] ?>"></marquee>
						<input type="submit" name="tsubmit" value="update">
				    </form>
	</div>
